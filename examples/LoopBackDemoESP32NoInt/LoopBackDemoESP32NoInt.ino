//——————————————————————————————————————————————————————————————————————————————
//  ACAN2518FD Demo in loopback mode, for ESP32, no interrupt pin
//——————————————————————————————————————————————————————————————————————————————
...
static const byte MCP2518_SCK  = 26 ; // SCK input of MCP2518
static const byte MCP2518_MOSI = 19 ; // SDI input of MCP2518
static const byte MCP2518_MISO = 18 ; // SDO output of MCP2518

static const byte MCP2518_CS  = 16 ; // CS input of MCP2518

//——————————————————————————————————————————————————————————————————————————————
//  ACAN2518FD Driver object
//——————————————————————————————————————————————————————————————————————————————

ACAN2518FD can (MCP2518_CS, SPI, 255) ; // Last argument is 255 -> no interrupt pin
